package com.mongxin.harmony.admin.service.impl;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.UUID;
import com.mongxin.harmony.admin.common.biz.user.UserContext;
import com.mongxin.harmony.admin.common.convention.exception.ClientException;
import com.mongxin.harmony.admin.common.enums.UserErrorCodeEnum;
import com.mongxin.harmony.admin.dao.entity.UserDO;
import com.mongxin.harmony.admin.dao.mapper.UserMapper;
...
import static com.mongxin.harmony.admin.common.constant.RedisCacheConstant.LOCK_USER_REGISTER_KEY;
import static com.mongxin.harmony.admin.common.constant.RedisCacheConstant.USER_LOGIN_KEY;
import static com.mongxin.harmony.admin.common.enums.UserErrorCodeEnum.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public UserLoginRespDTO login(UserLoginReqDTO requestParam) {
        ...
        stringRedisTemplate.opsForHash()
                .put(USER_LOGIN_KEY + requestParam.getUsername(), uuid,
    ...
    public Boolean checkLogin(String username, String token) {
        return stringRedisTemplate.opsForHash().get(USER_LOGIN_KEY + username, token)
                != null;
    }
