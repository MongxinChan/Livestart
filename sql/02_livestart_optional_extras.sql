/*
 * LiveStart optional extras bundle.
 *
 * This file creates the pay-sharding schemas and loads deterministic demo data.
 * The default graduation setup uses 00_livestart_full_schema.sql only.
 * Run this file only when both optional pay sharding and demo data are wanted.
 */

SET NAMES utf8mb4;

-- ============================================================================
-- BEGIN 08_pay_service_sharding.sql
-- ============================================================================
...
-- END 08_pay_service_sharding.sql

-- ============================================================================
-- BEGIN 05_test_seed_data.sql
-- ============================================================================
-- =============================================================================
...
--
-- 执行：mysql -uroot -p123456 < sql/02_livestart_optional_extras.sql
