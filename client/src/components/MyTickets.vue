    ...
    <a-card class="glass-panel" :bordered="false">
      <template #title>
        <span style="font-size: 1.15rem; font-weight: 800">
          <FileTextOutlined style="margin-right: 8px; color: var(--ant-color-primary)" /> 我的购票电子门票夹
        </span>
      </template>
      <template #extra>
      ...
      <div v-else style="display: flex; flex-direction: column; gap: 20px">
        ...
        >
          ...
          <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 14px; padding-top: 10px; border-top: 1px solid rgba(var(--ls-accent-rgb), 0.08)">
            ...
            <template v-if="order.status === 1 && !order.isChecked">
...
import {
  SafetyCertificateOutlined, FileTextOutlined, QrcodeOutlined,
